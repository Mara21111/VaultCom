...
import { User_relationship } from '../models/User_relationship';
...
export class UserRelationshipService {
  ...
  public constructor(private http: HttpClient, private Service: User_relationship) {}
  ...
  public sendRequest(sender_id: number, reciever_id: number): Observable<void> {
    return this.http.get<void>('http://localhost:5000/api/UserRelationship/send-request-from' + sender_id + '-to' + reciever_id)
  }

  public cancelRequest(sender_id: number, reciever_id: number): Observable<void> {
    return this.http.get<void>('http://localhost:5000/api/UserRelationship/cancel-request-from' + sender_id + '-to' + reciever_id)
  }

  public acceptRequest(sender_id: number, reciever_id: number): Observable<void> {
    return this.http.get<void>('http://localhost:5000/api/UserRelationship/accept-request-from' + sender_id + '-to' + reciever_id)
  }

  public rejectRequest(sender_id: number, reciever_id: number): Observable<void> {
    return this.http.get<void>('http://localhost:5000/api/UserRelationship/reject-request-from' + sender_id + '-to' + reciever_id)
  }

  public toggleBlockUser(user_id: number, blocked_user_id: number): Observable<void> {
    return this.http.get<void>('http://localhost:5000/api/UserRelationship/toggle-' + user_id + '-block-' + blocked_user_id)  //toggle-{user_id}-block-{blocked_user_id}
  }

  public toggleMuteUser(user_id: number, muted_user_id: number): Observable<void> {
    return this.http.get<void>('http://localhost:5000/api/UserRelationship/toggle-' + user_id + '-mute-' + muted_user_id)
  }

  public changeNickname(user_id: number, friend_id: number): Observable<void> {
    return this.http.get<void>('http://localhost:5000/api/UserRelationship/change-' + user_id + '-nickname-of-' + friend_id)
  }

  public unfriendUser(user_id: number, friend_id: number): Observable<void> {
    return this.http.get<void>('http://localhost:5000/api/UserRelationship/unfriend-' + friend_id + '-from-' + user_id)
  }
}